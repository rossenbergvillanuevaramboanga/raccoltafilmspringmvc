		...
		<main class="flex-shrink-0">
			<div class="container">
					...
					<div class='card'>
					    ...
					    <div class='card-body'>
								...
								<form:form method="post" modelAttribute="edit_film_attr" action="${pageContext.request.contextPath }/film/update" novalidate="novalidate" class="row g-3">
								    <form:hidden path="id"/>
									<div class="col-md-6">
			...
			<!-- 						</div> -->
								...
								<script>
									...
									$("#registaSearchInput").change(function (event,ui){
										 if (this.value == '' ) {
								              $('#registaId').val(null);
								              return false;
										 }
